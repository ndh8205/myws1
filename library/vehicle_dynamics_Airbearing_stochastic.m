function xdot = vehicle_dynamics_Airbearing_stochastic( X, U, w, dt, params )
    ...
    Open_Valve = U(1:8);
    RW_tau = cmd2tq_origin( U(9), idle, params, dt );
    ...
    Fx = final_FT(1) + w(1);
    Fy = final_FT(2) + w(2);
    Tau = final_FT(3) + RW_tau + w(3);
    
    % force & Moment

    % 6 DOF Rocket Modeling 0.2862
