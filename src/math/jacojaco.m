...
function [ A, B, C, D ] = ABSat_dynamcis(X_eq, U_eq, params)
    ...
    % Symbolic variables
    syms Xs Ys Zs Us Vs Ws phi_s the_s psi_s p_s q_s R_s real
    ...
    % sym state vector & control vector
    Xss = [ Xs; Ys; Zs; Us; Vs; Ws; phi_s; the_s; psi_s; p_s; q_s; R_s ];
    Uss = [ Us1; Us2; Us3; Us4; Us5; Us6; Us7; Us8 ];
    PRs_SET = [M Ts Ds J1 J2 J3]';

    RI2B = GetDCM_Euler( Xss(9), Xss(8), Xss(7) );
    RB2I = RI2B';

    WW = [ 1, sin( Xss(7) ) * tan( Xss(8) ), cos( Xss(7) ) * tan( Xss(8) );
           0, cos( Xss(7) ), -sin( Xss(7) );
           0, sin( Xss(7) ) / cos( Xss(8) ), cos( Xss(7) ) / cos( Xss(8) ) ];
    ...
    xs3_dot = WW * [ Xss(10); Xss(11); Xss(12) ];
