...
for i = 1:numSteps
    ...
    [ U , computation_time, predicted_trajectory ] = Controller_NMPC(X, X_target, dt, params);
    % [ U , computation_time, predicted_trajectory ] = Controller_NMPC_KJC(X, X_target, dt, params);
    % [ U , computation_time ] = Controller_RL_NMPC(X, X_target, dt, params);

    % RK4 시뮬레이션
%     X = rk4(@vehicle_dynamics_Airbearing, X, U, simulationTimeStep, params);
    X = srk4( @vehicle_dynamics_Airbearing_stochastic, X, U, Qw, params, dt );
