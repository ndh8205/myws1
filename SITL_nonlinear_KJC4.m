...
addpath(genpath('C:\Users\me\Desktop\airbearing_test\ABTB_MPC_KJC4'));
...
for i = 1:numSteps
    ...
    % [ X, P, yhat, X_predict ] = processDataSIM( z, P, X, X_target, zeros(9,1), params, 1/Main_Hz );

    command = U(9);

    [ U , computation_time, predicted_trajectory] = Controller_NMPC_KJC4(X, X_target, command, max_torque, idle, dt, params, XF);
